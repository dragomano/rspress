...
Если [мультиязычность](/guide/default-theme/i18n) не включена, значение по умолчанию:
...
Если [мультиязычность](/guide/default-theme/i18n) включена, будет использоваться [групповая конфигурация](#group), а значение по умолчанию:
